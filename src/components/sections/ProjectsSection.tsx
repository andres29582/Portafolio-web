...
function StatusBadge({
  ...
  status: string;
  labels: ProjectsContent["statusLabels"];
}) {
  const config = {
    completed: { label: labels.completed, variant: "success" as const },
    inProgress: { label: labels.inProgress, variant: "warning" as const },
    concept: { label: labels.concept, variant: "default" as const },
  };
  const cfg = config[status as keyof typeof config] ?? config.concept;
